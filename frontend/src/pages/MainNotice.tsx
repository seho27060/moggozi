  ...
  return (
    <div className={styles.container}>
      <div className={styles.notice}>
        ...
        <div className={styles.sentence1} data-aos="fade-up" data-aos-duration="1000"  >
          <div>꼭꼭 숨겨왔던 나만의 취미가 있나요?</div>
          <div>자신의 취미를 챌린지로 등록해보세요.</div>
          <div>자신만의 노하우를 듬뿍 담아 도전과제를 생성할 수 있습니다.</div>
        </div>

        <div className={styles.image1} data-aos="fade-up" data-aos-duration="1000" >
          <img src={image1} alt="" />
        </div>

        {/* 2 */}

        <div className={styles.sentence2} data-aos="fade-up" data-aos-duration="1000"  >
          <div>챌린지 생성</div>
        ...
        <div className={styles.image2} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image2} alt="" />
        </div>

        {/* 3 */}
        <div className={styles.odd}>
        <div className={styles.sentence3} data-aos="fade-up" data-aos-duration="1000"  >
          <div>스테이지 생성</div>
        ...
        <div className={styles.image3} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image3} alt="" />
        </div>
        ...
        <div className={styles.sentence4} data-aos="fade-up" data-aos-duration="1000"  >
        ...
        <div className={styles.image4} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image4} alt="" />
        </div>
        ...
        <div className={styles.odd}>
        <div className={styles.sentence5} data-aos="fade-up" data-aos-duration="1000" >
        ...
        <div className={styles.image5} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image5} alt="" />
        </div>
        {/* 6 */}


        <div className={styles.sentence6} data-aos="fade-up" data-aos-duration="1000" >
          <div>검색하기</div>
        ...
        <div className={styles.image6} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image6} alt="" />
        </div>
        {/* 7 */}

        <div className={styles.odd}>
        <div className={styles.sentence7} data-aos="fade-up" data-aos-duration="1000" >
        ...
        <div className={styles.image7} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image7} alt="" />
        </div>

        {/* 8 */}
        <div className={styles.sentence8} data-aos="fade-up" data-aos-duration="1000" >
          <div>리뷰와 댓글</div>
        ...
        <div className={styles.image8} data-aos="fade-up" data-aos-duration="1000"  >
          <img src={image8} alt="" />
        </div>
