  ...
  return (
    <div className={styles.container}>
      <div className={styles.notice}>
        ...
        {/* 2 */}
        <div className={styles.image2} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image2} alt="" />
        </div>

        <div className={styles.sentence2} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <div>챌린지 생성</div>
        ...
        {/* 3 */}
        <div className={styles.image3} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image3} alt="" />
        </div>
        <div className={styles.odd}>
        <div className={styles.sentence3} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <div>스테이지 생성</div>
        ...
        <div className={styles.image4} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image4} alt="" />
        </div>

        <div className={styles.sentence4} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
        ...
        <div className={styles.image5} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image5} alt="" />
        </div>
        <div className={styles.odd}>
        <div className={styles.sentence5} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom">
        ...
        <div className={styles.image6} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image6} alt="" />
        </div>

        <div className={styles.sentence6} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom">
          <div>검색하기</div>
        ...
        <div className={styles.image7} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image7} alt="" />
        </div>
        <div className={styles.odd}>
        <div className={styles.sentence7} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom">
        ...
        <div className={styles.image8} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom" >
          <img src={image8} alt="" />
        </div>

        <div className={styles.sentence8} data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom">
          <div>리뷰와 댓글</div>
