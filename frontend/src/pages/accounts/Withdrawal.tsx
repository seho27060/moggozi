...
const Withdrawal = () => {
  ...
  return (
    <div>
      ...
      <p>
        이메일 ID에 소셜 계정을 연결한 경우 탈퇴 시 연결 정보도 함께 삭제됩니다.
      </p>
      <br />
      ...
      <h4>개인정보 보관</h4>
      <p>
        회원 탈퇴 시 일부 개인정보는 개인정보처리방침에 따라 탈퇴일로부터 30일간
        보관되며, 그 이후 관계법령에 필요한 경우에는 별도 보관합니다.
      </p>
      <br />
      <h4>탈퇴 후 제한</h4>
      ...
      <form>
        ...
        <br />
        <br />
        <button onClick={withdrawalSubmitHandler}>회원 탈퇴</button>
      </form>
      <Modal
