...
const ChallengeItem: React.FC<{ challenge: ChallengeItemState }> = ({
  ...
  return (
    ...
    <div className={styles.challengeItem}>
      {challenge.img ? <img src={challenge.img} alt="challenge Img"></img> : <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2vD3MC0-zWEcZYdaZg3s-1fC0q9p5IMwOmA&usqp=CAU" alt=""></img>}
      <div className={(() => {
