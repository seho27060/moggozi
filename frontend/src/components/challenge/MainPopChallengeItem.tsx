...
const MainPopChallengeItem: React.FC<{ challenge: ChallengeItemState }> = ({
  challenge,
}) => {
    ...
    <Link to={`/challenge/${challenge.id}`} className={styles.link}>
      <div className={styles.challengeItem}>
        ...
        {/* 난이도 + 작성자 */}
            ...
            <div className={styles.challengeUserInfo}>
              <div className={styles.userInfo}>
              {challenge.writer.img ? <img className={styles.userImg} src={challenge.writer.img} alt="" /> : <img className={styles.userImg} src="https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png" alt="" />}
...
export default MainPopChallengeItem;
