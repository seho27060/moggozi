  ...
  return (
    <div>
      ...
      >
          ...
          {userId === writerId && state === 0 && <MenuItem onClick={registerHandler}>
            <div>챌린지 등록</div></MenuItem>}

          <MenuItem onClick={() => {navigate(`/stage/${id}`)}}>
            <div>스테이지 편집</div>
          </MenuItem>

          <Link to={`/challenge/${id}/update`} state={loadedChallenge} style={{textDecoration: "none"}} >
